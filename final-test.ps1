# Final Simple Test - Minimal PowerShell
Write-Host "GAME PERFORMANCE TEST" -ForegroundColor Cyan
...
$logFile = "test.log"
Start-Process -NoNewWindow -FilePath "cargo" -ArgumentList "run -p worker" -RedirectStandardOutput $logFile -RedirectStandardError "test.error"
...
if (Test-Path $logFile) {
    ...
    $stats = ($content | Select-String "PERFORMANCE STATS").Count
