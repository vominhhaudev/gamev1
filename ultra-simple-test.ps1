# Ultra Simple Test - Minimal PowerShell Script
# Su dung chi ky tu ASCII co ban de tranh tat ca loi parsing

Write-Host "ULTRA SIMPLE PERFORMANCE TEST" -ForegroundColor Cyan
...
# 4. Run extended test
Write-Host "4. Running extended test (60 seconds)..." -ForegroundColor Yellow

$logFile = "ultra_test.log"
Start-Process -NoNewWindow -FilePath "cargo" -ArgumentList "run -p worker" -RedirectStandardOutput $logFile -RedirectStandardError "ultra_test.error"
